...
## draw 
plot(hpc.window$Time, hpc.window$Sub_metering_1, type="l", xlab = "", ylab="Energy sub metering")
lines(hpc.window$Time, hpc.window$Sub_metering_2, col="red")
lines(hpc.window$Time, hpc.window$Sub_metering_3, col="blue")
